package com.dipu.ecommerce.gateway.security;
...
public class JwtGatewayFilter implements GatewayFilter,Ordered{
	...
	public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
		...
		ServerHttpRequest modifiedRequest = exchange.getRequest().mutate().header("X-User-Id", userId)
	...
	private static final Map<String, Map<String, List<String>>> ROLE_API_PERMISSION=
			...
			Map.of("ADMIN",Map.of("GET",List.of("/api/products"),
